...
/**
 * @param {object} els - { signedOutEl, notAdminEl, contentEl, signInBtn, signOutBtn, notAdminSignOutBtn }
...
export function initAdminGuard(els, onReady) {
  const { signedOutEl, notAdminEl, contentEl, signInBtn, signOutBtn, notAdminSignOutBtn } = els;
